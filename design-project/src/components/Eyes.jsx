...
function Eyes() {
  ...
  return (
    <div className="relative eyes w-full h-screen overflow-hidden bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]">
      <div className="flex gap-10 absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] w-1/2 z-10">
